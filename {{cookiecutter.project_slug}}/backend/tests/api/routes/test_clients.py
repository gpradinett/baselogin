...
def test_create_client(
    ...
    data = {"name": "Test Client", "redirect_uris": ["http://localhost:8000/callback"], "scopes": ["read", "write"]}
    r = client.post(
        f"{settings.API_V1_STR}/clients/", headers=superuser_token_headers, json=data
    )
